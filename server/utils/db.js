...
const defaultProjects = [
  {
    ...
    "year": "2025",
    "images": [
      "/images/projects-wide/1.webp",
      "/images/projects-wide/2.webp",
      "/images/projects-wide/3.webp"
    ]
  },
  {
    "id": "2",
...
const defaultGallery = [
  {
    "id": "1",
    "img": "/images/projects-wide/1.webp",
    "title": "Contemporary Office Architecture",
    "category": "Commercial"
  },
  {
    "id": "2",
    "img": "/images/projects-wide/2.webp",
    "title": "Luxury Penthouse Fit-Out",
    "category": "Interiors"
  },
  {
    "id": "3",
    "img": "/images/projects-wide/3.webp",
    "title": "Scandinavian Styled Kitchen",
    "category": "Interiors"
  },
  {
    "id": "4",
    "img": "/images/projects-wide/4.webp",
    "title": "Oceanside Villa Exterior",
  ...
  },
  {
    "id": "6",
    "img": "/images/projects-wide/6.webp",
    "title": "Premium Restaurant Fit-Out",
    "category": "Commercial"
  },
  {
    "id": "7",
  ...
  },
  {
    ...
    "title": "Glass Office Headquarters",
    "category": "Commercial"
  },
  {
    "id": "9",
    "img": "/images/services/3.webp",
    "title": "Modern Villa Blueprint Rendering",
...
const initializeLocalData = () => {
  ...
  if (projects.length === 0) {
    ...
    console.log('Local projects initialized with default data.');
  }
  const gallery = getGallery();
  if (gallery.length === 0) {
    saveGallery(defaultGallery);
    console.log('Local gallery items initialized with default data.');
  }
};
