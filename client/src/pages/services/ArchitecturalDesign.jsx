...
const fallbackShowcase = [
  { img: '/images/projects-wide/4.webp', title: 'Custom Villa Conceptualization', category: 'Architectural' },
  { img: '/images/projects-wide/5.webp', title: 'Modern Facade Elevation', category: 'Architectural' },
  { img: '/images/projects-wide/6.webp', title: 'Steel Frame Headquarters Layout', category: 'Architectural' }
];
    ...
    const loadShowcase = async () => {
      try {
        ...
        const filtered = (res.data || []).filter(item => 
          item.category && item.category.toLowerCase() === 'architectural'
        );
                ...
                <div className="hover relative overflow-hidden rounded-1 border border-light-subtle shadow-sm">
                  ...
                  <div className="abs z-4 p-4 bottom-0 mb-0 text-light w-100">
                    ...
                    <p className="mb-0 fs-13 text-white-50" style={{ lineHeight: '1.4' }}>
                      {item.desc || (item.category ? `Premium ${item.category.toLowerCase()} blueprint elevation design.` : 'Bespoke custom architectural design solutions.')}
                    </p>
                  </div>
                </div>
              </div>
